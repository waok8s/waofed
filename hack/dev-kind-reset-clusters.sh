...
create-cluster "$cluster1" "$KIND_IMAGE"
create-cluster "$cluster2" "$KIND_IMAGE"
create-cluster "$cluster3" "$KIND_IMAGE"

setup-kubefed "$cluster0" "$KUBEFED_VER"
join-kubefed "$cluster1" "$cluster0"
join-kubefed "$cluster2" "$cluster0"
join-kubefed "$cluster3" "$cluster0"
